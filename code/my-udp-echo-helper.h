 ...
 */
class MyUdpEchoClientHelper
{
public:
  /**
   * Create MyUdpEchoClientHelper which will make life easier for people trying
   ...
   */
  MyUdpEchoClientHelper (Address ip, uint16_t port);
  /**
   * Create MyUdpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  MyUdpEchoClientHelper (Address addr);
